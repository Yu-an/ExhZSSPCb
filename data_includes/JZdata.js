...
var host = "https://raw.githubusercontent.com/Yu-an/ExhZSSPCb/master/chunk_includes/";
var defaults = [
    "DynamicQuestion", {
...
var items = [
    ...
    ["Tutorial", "DynamicQuestion", {
        ...
        elements: [
              "<b>练习</b> <span id='score' />",
              //Audio file type MP3 should be speficied, as mpeg
              "<p id='audio'> "<audio src= 'https://raw.githubusercontent.com/Yu-an/ExhZSSPCb/master/chunk_includes/sound/Prac1-t.MP3' type='audio/mpeg' controls='controls' autoplay='autoplay'> </audio>",</p>",
              $("<div id='pic'>").append(
                  newCalendar([{person: "Prac1.png", wednesday:getCoveredPic("Pract1-uncover.png", goodClick)},])
              ),
              ...
              {pause: "key\x01"},
              {func: function(t){
                  if (t.justClickedOn.attr("id") == "wednesday0") $("#tuesday0").removeAttr("dontclick");
